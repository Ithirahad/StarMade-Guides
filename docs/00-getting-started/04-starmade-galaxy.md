...
As you might expect the community has a lot of questions regarding how the two StarMades compare and what might one day be transferable. I've tried to compile the most commonly asked questions below and the answers from the developers. Please note, all of this is **subject to change without notice** and is just what we know so far as a community, not an actual plan for development. Please do not yell at our lovely developers due to any of these comments!

### What shape will planets take in StarMade Galaxy?
...
### Will I be able to import ship blueprints?
...
### How will star systems be structured now?
...
### Can I help make StarMade Galaxy?
...
### Will most of the non game infrastructure like the Discord and dock be carried over?
...
### So you jump to a system now and then fly inside of it?
